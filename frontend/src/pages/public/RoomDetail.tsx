...
export default function RoomDetail() {
  ...
  const submitReport = () => {
    ...
    toast.success('Gửi báo cáo thành công!', {
      description: 'Quản trị viên sẽ xem xét báo cáo của bạn sớm nhất.'
    });
    ...
    <div className="max-w-7xl mx-auto px-4 pt-4 pb-28 md:py-8 space-y-6 md:space-y-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-64 md:h-96">
        <div className="md:col-span-2 h-full bg-gray-200 rounded-2xl overflow-hidden relative group cursor-pointer" onClick={() => setShowGallery(true)}>
          ...
          <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 z-10">
            <span className="text-white text-xs font-bold">🕒 Cập nhật: 30/06/2026 22:25</span>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6 md:space-y-8">
          <div>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 md:mb-2">Studio Cao Cấp Hiện Đại - Quận 3</h1>
          ...
          <div>
            <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Mô tả</h2>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              Studio hiện đại đầy đủ nội thất nằm ngay trung tâm Quận 3. Rất gần các trường đại học, cửa hàng tiện lợi và quán cà phê. Tòa nhà có bảo vệ 24/7, khóa vân tay và máy giặt miễn phí trên sân thượng.
            </p>
          </div>
          
          <Button variant="ghost" className="mt-4 text-red-500 hover:text-red-700 hover:bg-red-50 self-start flex items-center gap-2" onClick={() => setShowReportModal(true)}>
            ⚠️ Báo cáo vi phạm
          </Button>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <Card className="p-5 md:p-6 md:sticky md:top-24">
            <div className="mb-6">
              ...
              <p className="text-xs md:text-sm text-gray-500 mt-2">Tiền cọc: 5.500.000₫</p>
            </div>
            ...
            <div className="hidden md:flex flex-col space-y-4 mb-6">
              ...
              <Button fullWidth variant="outline" size="lg" onClick={handleChat}>Nhắn tin với chủ trọ</Button>
            </div>
            ...
            <div className="pt-5 md:pt-6 border-t border-gray-100">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-sm md:text-base">Lê Văn B</p>
                  <div className="flex items-center gap-2">
                    <span className="text-yellow-500 text-xs md:text-sm">★ 4.9 (12 đánh giá)</span>
                  </div>
                </div>
              </div>
              <div className="mt-4 bg-gray-50 p-3 rounded-lg flex items-center justify-between">
                <span className="text-xs md:text-sm text-gray-600">Điểm uy tín</span>
        ...
        <div className="fixed inset-0 bg-black z-50 overflow-y-auto">
          <div className="p-4 md:p-6 min-h-screen flex flex-col">
            <div className="flex justify-between items-center mb-6 md:mb-8 sticky top-0 bg-black/90 pb-4 z-10">
              <h2 className="text-white text-xl md:text-2xl font-bold">Ảnh phòng trọ</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
              {MOCK_PHOTOS.map((photo, i) => (
                <div key={i} className="aspect-[4/3] rounded-lg overflow-hidden bg-gray-800 relative group">
                  ...
                  <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 z-10">
                    <span className="text-white text-xs font-bold">🕒 Cập nhật: 30/06/2026 22:25</span>
                  </div>
                </div>
              ))}
      ...
      {showReportModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl w-full max-w-md shadow-lg overflow-hidden animate-in fade-in zoom-in-95">
            <div className="p-4 border-b border-neutral-100 flex justify-between items-center">
              <h3 className="font-bold text-base md:text-lg text-neutral-900 flex items-center gap-2">⚠️ Báo cáo vi phạm</h3>
              <button onClick={() => setShowReportModal(false)} className="text-neutral-400 hover:text-neutral-700 font-bold px-2">✕</button>
            </div>
            <div className="p-5 md:p-6 space-y-4">
              <div>
                ...
                >
                  ...
                  <option value="Ảnh sai thực tế">Ảnh sai thực tế</option>
                  <option value="Lừa đảo tiền cọc">Lừa đảo tiền cọc</option>
                  <option value="Giá ảo/Khác thực tế">Giá ảo/Khác thực tế</option>
                  <option value="Phòng không còn trống">Phòng không còn trống</option>
                  <option value="Khác">Khác</option>
                </select>
              </div>
              <p className="text-xs text-gray-500 text-center mt-2">
                Quản trị viên sẽ xem xét báo cáo của bạn trong vòng 24h.
              </p>
              <Button fullWidth size="lg" className="mt-4 bg-red-600 hover:bg-red-700 text-white" onClick={submitReport}>Gửi báo cáo</Button>
            </div>
          </div>
        </div>
      )}
